            ...
            <div className={classes.container}>
                ...
                <div className={classes.wrapper}>
                    <div className={classes.socials}>
                        <p className={classes.subtitle}>How about <span>say hi ? </span>Contact me via socials or just
                            fill out the form.</p>
                        <div className={classes.icons}>
                            ...
                            <a href="https://www.codewars.com/users/Nariu9" target={'_blank'}
                               rel={'noreferrer'}><SiCodewars/></a>
